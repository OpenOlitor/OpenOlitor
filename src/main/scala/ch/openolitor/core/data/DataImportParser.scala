        ...
        row =>
          ...
          (AbotypId(UUID.randomUUID),
            AbotypModify(
              ...
              lieferrhythmus = Rhythmus.parse(row.value[String](indexlieferrhytmus)),
              ...
              preiseinheit = Preiseinheit.parse(row.value[String](indexPreiseinheit)),
              laufzeit = row.value[Option[Int]](indexLaufzeit),
              laufzeiteinheit = Laufzeiteinheit.parse(row.value[String](indexLaufzeiteinheit)),
